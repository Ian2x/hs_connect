...
import 'package:hs_connect/shared/tools/noFlingScrollPhysics.dart';
import 'package:hs_connect/shared/widgets/loading.dart';
import 'package:hs_connect/shared/widgets/postsListView.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';
import 'package:provider/provider.dart';

class DomainFeed2 extends StatefulWidget {
  final UserData currUser;

  const DomainFeed2({Key? key, required this.currUser}) : super(key: key);

  @override
  _DomainFeed2State createState() => _DomainFeed2State();
}

class _DomainFeed2State extends State<DomainFeed2> {
  ...
  Widget build(BuildContext context) =>
      PagedListView<DocumentSnapshot?, Post>(
