...
class CustomGestureDetector extends StatelessWidget{
  ...
  CustomGestureDetector({required this.child,required this.velocity,
    required this.onSwipeLeft,required this.onSwipeRight,required this.onSwipeUp,
    required this.onSwipeDown,required this.axis});
