  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              onPressed: () {
                showModalBottomSheet(
                    ...
                    builder: (context) => ReportSheet(
                        reportType: ReportType.message, entityRef: otherUserRef, entityCreatorRef: otherUserRef));
              },
            ),
          ]),
      body: Column(children: <Widget>[
        ...
        Container(height: 0, color: colorScheme.onSurface), //can add domain color but...
        MessagesForm(
            otherUserRef: otherUserRef,
